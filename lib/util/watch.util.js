...
function watch(app, callback) {

    var watcher = _chokidar2.default.watch(app, {
        ignored: /[\/\\]\./,
        persistent: true,
        ignoreInitial: true
    });
    ...
    watcher.on('add', function (filePath, stats) {
        ...
        var fileRuntimePath = filePath.replace("" + app, "" + _index2.default.runtime);
    ...
    watcher.on('unlink', function (filePath, stats) {
        ...
        var runtimePath = filePath.replace("" + app, "" + _index2.default.runtime);
    ...
    watcher.on('unlinkDir', function (dirPath) {
        ...
        var dirRuntimePath = dirPath.replace("" + app, "" + _index2.default.runtime);
